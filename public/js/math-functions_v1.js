...
function spectraVelocity(input) {
  ...
  return resultsOnce.map((v) => v * 0.31375 * 0.5 * 4.1891 * 0.4166);
}
...
function waveformVelocity(input) {
  const fixedMultiplier = (1.37 * 5.45 * 0.5 * 2.4444 * 1.1 * 1.2) / 3.13;
...
function waveformDisplacement(input) {
  const fixedMultiplier = 50 * 0.12 * 2.92;
  // Convertir la entrada en un array de números
...
function processWaveform(arr) {
  const fixedMultiplier = (2.5 * 2 * 1.46 * 0.8148) / 1.45;
